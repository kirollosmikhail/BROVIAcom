...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="divdati">
        <div class="contdati">
            ...
            <div>
                <asp:Label runat="server" Text="Data del report"></asp:Label>
                <asp:TextBox ID="txtDataReport" runat="server" type="text" CssClass="form-control textbox" placeholder="data del report" TextMode="Date" />
            </div>
        </div>
        <div class="contdati">
            <div>
