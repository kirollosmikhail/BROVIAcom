...
<div class="table-container" style="width:50%">
    <asp:GridView ID="GridView3" CssClass="gridview" runat="server" AutoGenerateColumns="False" DataKeyNames="Cod_Tipo_Commessa" OnSelectedIndexChanged="GridView3_SelectedIndexChanged" OnPageIndexChanging="paging">
        <Columns>
